...
Our method can be used to classify individuals into discrete groups based on self-reported race/ethnicity (i.e., Black/African, Asian, and White/Caucasian) or to describe individuals on an ancestral continuum that more accurately reflect the nature of human populations.
