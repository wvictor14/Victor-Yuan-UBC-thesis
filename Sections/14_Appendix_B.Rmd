...
```{r figb1, fig.cap="(ref:figb1-cap)", fig.scap = "Fluorescence-activated cell-sorting and immune fluorescence staining", eval=TRUE, echo=T, echo=FALSE, fig.align='center', out.extra=''}
...
```{r figb2, fig.cap="(ref:figb2-cap)", fig.scap = "Identifying maternal contamination", eval=TRUE, echo=T, echo=FALSE, fig.align='center', out.extra=''}
...
```{r figb3, fig.cap="(ref:figb3-cap)", fig.scap = "Principal component associations with phenotype variables", eval=TRUE, echo=T, echo=FALSE, fig.align='center', out.extra=''}
...
```{r figb4, fig.cap="(ref:figb4-cap)", fig.scap = "First trimester differentially methylated CpGs enrichment for genomic location", eval=TRUE, echo=T, echo=FALSE, fig.align='center', out.extra=''}
...
```{r figb5, fig.cap="(ref:figb5-cap)", fig.scap = "Mean DNAm for each cell type across CpGs in selected functionally-relevant genes", eval=TRUE, echo=T, echo=FALSE, fig.align='center', out.extra=''}
...
```{r figb6, fig.cap="(ref:figb6-cap)", fig.scap = "Mean DNAm for each cell type across CpGs in selected preeclampsia genes", eval=TRUE, echo=T, echo=FALSE, fig.align='center', out.extra=''}
...
```{r figb7, fig.cap="(ref:figb7-cap)", fig.scap = "Density graphs of CpGs in imprinted regions",  eval=TRUE, echo=T, echo=FALSE, fig.align='center', out.extra=''}
...
```{r figb8, fig.cap="(ref:figb8-cap)", fig.scap = "DNAm at imprinted regions for FGF8 and FGF12", eval=TRUE, echo=T, echo=FALSE, fig.align='center', out.extra=''}
...
```{r figb9, fig.cap="(ref:figb9-cap)", fig.scap = "DNAm at imprinted regions for JMJD1C and FGF14", eval=TRUE, echo=T, echo=FALSE, fig.align='center', out.extra=''}
...
```{r figb10, fig.cap="(ref:figb10-cap)", fig.scap = "DNAm at imprinted regions for RASGRF1", eval=TRUE, echo=T, echo=FALSE, fig.align='center', out.extra=''}
...
```{r figb11, fig.cap="(ref:figb11-cap)", fig.scap = "DNAm summarized over repetitive elements", eval=TRUE, echo=T, echo=FALSE, fig.align='center', out.extra=''}
...
```{r figb12, fig.cap="(ref:figb12-cap)", fig.scap = "Comparison of cell deconvolution algorithms", eval=TRUE, echo=T, echo=FALSE, fig.align='center', out.extra=''}
...
```{r figb13, fig.cap="(ref:figb13-cap)", fig.scap = "Validating cell composition estimates", eval=TRUE, echo=T, echo=FALSE, fig.align='center', out.extra=''}
knitr::include_graphics(here::here('Images', 'appendix-b', 'Figure S13.pdf'))
```

<!----- Tables---->

<!--- set NAs to print as blanks -->
...
```{r tabb2, eval = FALSE, echo = T, echo=FALSE, warning = FALSE, message=FALSE,  out.extra=''}
...
```{r tabb3, eval = FALSE, echo = T, echo=FALSE, warning = FALSE, message=FALSE,  out.extra=''}
...
```{r tabb4, eval = FALSE, echo = T, echo=FALSE, warning = FALSE, message=FALSE,  out.extra=''}
...
readr::read_csv(here::here('Tables', 'appendix b', 'table s5.csv')) %>%
  ...
  select(-ONTOLOGY, -N, -DE, -ID, -neg_log_P, -Order) %>%
  kableExtra::kbl(
  booktabs = TRUE,
  caption = 'Top 10 GO enrichment for cell DMCs.',
  longtable = TRUE) 
```
...
readr::read_csv(here::here('Tables', 'appendix b', 'table s6.csv')) %>%
  select(Group, Celltype, Description, P.DE, FDR) %>%
  kableExtra::kbl(
  booktabs = TRUE,
...
readr::read_csv(here::here('Tables', 'appendix b', 'table s7.csv')) %>%
  dplyr::rename(`Methylated allele` = methylated_allele,
                `Tissue` = tissue_specificity,
                `Gene` = associated_gene,
                `sanchez delgado` = sanchez_delgado) %>%
  mutate(position = paste0(chr, ':', start, '-', end)) %>%
  select(position, everything(), -chr, -start, -end, -note) %>%
  pivot_longer(cols = court:hamada,
               names_to = 'author',
               values_to = 'covered'
  ) %>%
  filter(covered) %>%
  group_by(position) %>%
  mutate(publication = paste0(author, collapse = ', ')) %>%
  select(-author, -covered) %>%
  ungroup() %>%
  distinct() %>%
  kableExtra::kbl(
  booktabs = TRUE,
  ...
  longtable = TRUE) %>%
  kableExtra::column_spec(column = 4, width = '15em') %>%
  kableExtra::column_spec(column = 2, width = '5em') %>%
  kableExtra::column_spec(column = 5, width = '15em') %>%
...
```{r tabb9, eval = FALSE, echo = T, echo=FALSE, warning = FALSE, message=FALSE,  out.extra=''}
...
```{r tabb10, eval = FALSE, echo = T, echo=FALSE, warning = FALSE, message=FALSE,  out.extra=''}
