...
In this study, we developed planet (Placental DNAm Elastic Net Ethnicity Tool), an ethnicity classifier using DNAm and genotyping data measured on the 450k array in multiple cohorts of placentas from North America.
planet was developed on overlapping sites from 450k and the newer 850k/EPIC array to ensure compatibility with future studies.
