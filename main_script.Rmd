...
output_file: "Dissertation Victor Yuan.pdf"
header-includes:
   - \usepackage{ragged2e}
   - \usepackage{setspace}
   - \usepackage{tocloft}
...
\renewcommand*\contentsname{Table of Contents} <!-- Changes title to "Table of Contents" instead of "Contents" -->
...
<!-- Modify me! -->
# Maternal contamination in placental DNA methylation studies
...
<!-- ## Appendix A -->
## Appendix A - Supplementary information for Chapter Two, "Accurate ethnicity prediction from placental DNA methylation data
...
## Appendix B - Supplementary information for Chapter Three, "Cell-specific characterization of the placental methylome"
...
## Appendix C - Supplementary information for Chapter Four, "Maternal contamination in placental DNA methylation studies"
